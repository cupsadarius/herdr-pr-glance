...
func New(r SourceResolver, g GitHub, c Cache, now func() time.Time) *Model {
	...
	return &Model{resolver: r, github: g, cache: c, now: now, ctx: ctx, cancel: cancel, Section: model.Overview, Discussions: map[model.Section]*DiscussionState{}}
}
func (m *Model) Init() tea.Cmd  { return func() tea.Msg { return TickMsg{} } }
func (m *Model) View() tea.View { return tea.NewView("Glance PR") }
